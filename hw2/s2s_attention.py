...
attention_graph = AttentionGraph(LogLoss(), Adam(eta=0.001), dict_size, hidden_dim)
trainer.train(idx_dict, 100, 's2s_attention', attention_graph, train_ds, dev_ds, test_ds, 50)
