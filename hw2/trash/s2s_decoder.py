...
for i in range(epoch):
    ...
    logger.add_record(i, time() - origin_time, train_time, train_loss, train_acc, dev_loss, dev_acc, test_acc)
...
decode_graph.loss.errorStat = ErrorStat()
eval_on(dev_ds)

print("Top 20 Error Detail:")

for item in decode_graph.loss.errorStat.top(20):
